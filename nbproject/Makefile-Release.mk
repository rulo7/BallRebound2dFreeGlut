...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pelota_ulti: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pelota_ulti ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/Lapiz.o: src/Lapiz.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Lapiz.o src/Lapiz.cpp

${OBJECTDIR}/src/Obstaculo.o: src/Obstaculo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Obstaculo.o src/Obstaculo.cpp
...
${OBJECTDIR}/src/Triangulo.o: src/Triangulo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Triangulo.o src/Triangulo.cpp
